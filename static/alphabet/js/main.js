...
jQuery(function ($) {
    ...
    $(document).ready(function () {
        ...
        var myLatlng = new google.maps.LatLng(-7.8430996,110.3540679); //your latitude and longitude here
        ...
        var marker = new google.maps.Marker({
            ...
            icon: 'static/alphabet/img/mapmarker.png',
        ...
        $('#layerslider').layerSlider({
            ...
            skinsPath: 'static/alphabet/layerslider/skins/',
